...
info = '👮‍♂️┇من قبل ✭❯ ['..result.first_name_..'](t.me/'..(result.username_ or 'KENAEteam')..')\n'..text
...
if (text == "قفل التاك") then
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل التاك ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل التاك ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الشارحه ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الشارحه ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل التعديل ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل التعديل ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل التكرار ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل التكرار ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل المتحركه ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل المتحركه ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الملفات ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الملفات ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الماركدون ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الماركدون ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الصور ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الصور ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الملصقات ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الملصقات ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الفيديو ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الفيديو ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الانلاين ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الانلاين ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الدردشه ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الدردشه ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل التوجيه ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل التوجيه ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل التثبيت ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل التثبيت ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الاغاني ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الاغاني ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الصوت ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الصوت ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الجهات ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الجهات ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الميديا ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الميديا ✔️")
...
database:set("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  ...
  if tsX_o then
    tsX000("lock",msg,"🚸┇بالفعل تم قفل الروابط ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الروابط ✔️")
  ...
  if tsX_o then
   tsX000("lock",msg,"🚸┇بالفعل تم قفل المعرف ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل المعرف ✔️")
  ...
  if tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم قفل الاشعارات ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل الاشعارات ✔️")
  ...
  if tsX_o then
   tsX000("lock",msg,"🚸┇بالفعل تم قفل البوتات بالطرد ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم قفل البوتات بالطرد ✔️")
  ...
  tsX000("lock",msg,"🚸┇ تم قفل البوتات ✔️")
  ...
  local tsX_o = database:get("lock_new:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"🚸┇بالفعل تم فتح الاشعارات ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الاشعارات ✔️")
  ...
  local tsX_o = database:get("lock_tag:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح التاك ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح التاك ✔️")
  ...
  local tsX_o = database:get("lock_sarha:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الشارحه ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الشارحه ✔️")
  ...
  local tsX_o = database:get("lock_lllll:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح التكرار ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح التكرار ✔️")
  ...
  local tsX_o = database:get("lock_edit:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح التعديل ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح التعديل ✔️")
  ...
  local tsX_o = database:get("lock_gif:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"🚸┇بالفعل تم فتح المتحركه ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح المتحركه ✔️")
  ...
  local tsX_o = database:get("lock_files:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الملفات ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الملفات ✔️")
  ...
  local tsX_o = database:get("lock_mark:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الماركدون ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الماركدون ✔️")
  ...
  local tsX_o = database:get("lock_photo:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الصور ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الصور ✔️")
  ...
  local tsX_o = database:get("lock_stecker:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الملصقات ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الملصقات ✔️")
  ...
  local tsX_o = database:get("lock_video:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الفيديو ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الفيديو ✔️")
  ...
  local tsX_o = database:get("lock_inline:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الانلاين ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الانلاين ✔️")
  ...
  local tsX_o = database:get("lock_fwd:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح التوجيه ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح التوجيه ✔️")
  ...
  local tsX_o = database:get("lock_pin:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح التثبيت ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح التثبيت ✔️")
  ...
  local tsX_o = database:get("lock_audeo:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الاغاني ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الاغاني ✔️")
  ...
  local tsX_o = database:get("lock_voice:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الصوت ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الصوت ✔️")
  ...
  local tsX_o = database:get("lock_botAndBan:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح البوتات بالطرد ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح البوتات بالطرد ✔️")
  ...
  local tsX_o = database:get("lock_contact:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الجهات ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الجهات ✔️")
  ...
  local tsX_o = database:get("lock_media:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الميديا ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الميديا ✔️")
...
database:del("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  ...
  local tsX_o = database:get("lock_username:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح المعرف ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح المعرف ✔️")
  ...
  local tsX_o = database:get("lock_link:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"🚸┇بالفعل تم فتح الروابط ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح الروابط ✔️")
  ...
  local tsX_o = database:get("lock_bot:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"🚸┇بالفعل تم فتح البوتات ✔️")
  else
  tsX000("lock",msg,"🚸┇ تم فتح البوتات ✔️")
...
if text == "ارفع منشئ" and msg.reply_to_message_id_ then
...
تـآبع > [ جديدنا ](t.me/l_lTM)]]
  ...
  local h1 = redis:get('KENAE:'..bot_id..'h1')
     local text =  [[⦅ اوامر المجموعه باالمسح  ⦆
...
[ -تابع جديدنا🌐- ](t.me/QD_QQ)]]
  ...
  local text =  [[‏🚸𖡻 اوامر حمايه بالتقيد
➖➖➖➖➖➖➖➖➖➖➖
‏🎲𖡻 قفل/فتح  » بالتقيد
